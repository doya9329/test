...
public class MessageExam extends JFrame {
	...
	public MessageExam() {
		...
		button2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//사용자의 확인을 받는 대화상자
				int result=JOptionPane.showConfirmDialog(MessageExam.this, 
						"종료할까요?",	null, JOptionPane.YES_NO_OPTION);
		...
		button3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//키보드로 입력한 값을 변수에 저장
				String name=JOptionPane.showInputDialog(MessageExam.this, 
						"이름을 입력하세요");
		...
		button4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//버튼의 이름을 바꿈
				String[] str= {"추가","수정","삭제"};
				//yes,no,cancel 버튼을 사용자가 지정한 기능으로 변경
